...
const POSTS = {
  ...
  'how-much-does-a-mortgage-broker-website-cost': {
    ...
    content: [
      ...
      { type: 'p', text: 'We offer three tiers. Homepage only: £1,500, delivered in 5 working days. Full website: £2,500, delivered in 7 working days. Website + Leads: £3,500 per month — the full website built in the first month, then 10 qualified mortgage appointments booked into your diary every month after.' },
      { type: 'p', text: 'Every build includes: conversion-first layout built specifically for mortgage brokers, segmented CTAs for each client type, FCA compliance throughout, WhatsApp and Calendly integration, and a mobile-first build. The Care Plan is optional and priced separately at £150/month, with the first month free if you take it — no build requires it.' },
